...
async def api_probe_sub_one(request: web.Request) -> web.Response:
...
async def api_probe_generated_one(request: web.Request) -> web.Response:
...
def add_routes(app: web.Application) -> None:
    ...
    app.router.add_get("/api/subs/{sub_id}/probe/{idx}", api_probe_sub_one)
    app.router.add_get("/api/generated/{gen_id}/probe/{idx}", api_probe_generated_one)
